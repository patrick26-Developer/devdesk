...
export interface Category {
  ...
  chip: string;
  // Classe Tailwind de la pastille de couleur (à côté du titre de section dans la sidebar)
  dot: string;
  // Classe Tailwind de couleur de texte/icône seule (palette de commandes, listes)
  text: string;
}
